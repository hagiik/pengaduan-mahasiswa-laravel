...
use App\Filament\Clusters\PengaduanMahasiswa\Resources\PengaduanSelesaiResource\Pages;
use App\Filament\Clusters\PengaduanMahasiswa\Resources\PengaduanSelesaiResource\RelationManagers;
...
class PengaduanSelesaiResource extends Resource
{
    ...
    public static function getNavigationBadge(): ?string
    {
        ...
        $query = static::getModel()::query()
            ->whereHas('status', fn($q) => $q->where('status', 'Selesai'));
