...
use App\Filament\Clusters\PengaduanMahasiswa\Resources\PengaduanTerimaResource\Pages;
use App\Filament\Clusters\PengaduanMahasiswa\Resources\PengaduanTerimaResource\RelationManagers;
...
class PengaduanTerimaResource extends Resource
{
    ...
    public static function getNavigationBadge(): ?string
    {
        ...
        $query = static::getModel()::query()
            ->whereHas('status', fn($q) => $q->where('status', 'Diterima'));
    ...
    {
        return [
            'index' => Pages\ListPengaduanTerimas::route('/'),
            'create' => Pages\CreatePengaduanTerima::route('/create'),
