...
use App\Filament\Clusters\PengaduanMahasiswa\Resources\PengaduanProsesResource\Pages;
use App\Filament\Clusters\PengaduanMahasiswa\Resources\PengaduanProsesResource\RelationManagers;
...
class PengaduanProsesResource extends Resource
{
    ...
    public static function getNavigationBadge(): ?string
    {
        ...
        $query = static::getModel()::query()
            ->whereHas('status', fn($q) => $q->where('status', 'Diproses'));
    ...
    {
        return [
            'index' => Pages\ListPengaduanProses::route('/'),
            'create' => Pages\CreatePengaduanProses::route('/create'),
