    ...
    <div class="p-6">
        ...
        <div class="shadow-md rounded-lg p-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="font-medium">Tanggal & Jam:</label>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="border px-4 py-2 rounded flex justify-center">
                        ...
                        @else
                            <p class="text-gray-500">Tidak menyertakan gambar</p>
                        @endif
                    </div>
                </div>
            </div>
                        ...
                        @forelse ($tanggapans as $tanggapan)
                            <tr class="hover:">
                                ...
                                <td class="border px-4 py-2 text-center">
                                    ...
                                    @else
                                        <span class="text-gray-500">Tidak menyertakan gambar</span>
                                    @endif
                                </td>
                                <td class="border px-4 py-2">{{ \Carbon\Carbon::parse($tanggapan['created_at'])->format('d M Y H:i') }}</td>
                                <td class="border px-4 py-2">{{ \Carbon\Carbon::parse($tanggapan['created_at'])->format('H:i') }}</td>
                            </tr>
                        @empty
                            <tr>
